...
| M1 `lh-core` | **done** — every §8 item is in place, and it has grown past them: probe, checksums, SBE, verify, scan, tool registry, conversion, torrent read/write/tracker list, job queue (J1, J2) done; SBE repair ([docs/sbe-repair.md](docs/sbe-repair.md), R1–R4) done, including the TUI screen; etree naming, tagging and rename ([docs/tagging.md](docs/tagging.md), N1–N3) done |
